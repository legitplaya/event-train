...
{
    // Assuming you have a collection of users, e.g. a database or a list
    List<User> users = new List<User>();

    User? user = users.FirstOrDefault(p => p.Login == loginData.Login && p.Password == loginData.Password);
